...
pub extern "system" fn Java_com_shiroha_mmdskin_NativeFunc_BuildMCVertexBuffer(
    ...
    let pose_floats: &[f32] = unsafe { std::slice::from_raw_parts(pose_ptr as *const f32, 16) };
    ...
    let normal_floats: &[f32] = unsafe { std::slice::from_raw_parts(normal_ptr as *const f32, 9) };
